  ...
  <v-dialog
    ...
    <v-card class="">
      ...
      <v-row class="text-caption" v-if="false">
        <v-col cols="12">
          <h5>
            <hr> DEBUG FROM : ModalCreateTable
          </h5>
        </v-col>
        <v-col cols="3">
      ...
      <v-container class="pa-0">
        ...
        <v-stepper
          ...
          <!-- STEPPER ITEMS -->
          <v-stepper-items class="force-flat" v-if="true">
            ...
            <v-stepper-content
              ...
              <v-card
                ...
                <!-- IMPORT RESUME -->
                <!-- <div v-show="stepInfo.component === 'tableCreate'">
                  <div class="mt-5 mb-0">
                    <TableImportResume
                      :importType="importType"
                      :datasetItem="datasetItem"
...
<script>
  ...
  export default {
    ...
    components: {
      ...
      TableImportData: () => import(/* webpackChunkName: "TableImportData" */ '@/components/data/imports/TableImportData.vue'),
      // DatasetImportResume: () => import(/* webpackChunkName: "DatasetImportResume" */ '@/components/data/imports/DatasetImportResume.vue'),
      TableImportResume: () => import(/* webpackChunkName: "TableImportResume" */ '@/components/data/imports/TableImportResume.vue'),
    },
    props: [
      'item',
      'fromWorkspace',
